...
export const getAllBookingType = createActionTypes('GET_ALL_BOOKING');
export const getAllBookingAdminType = createActionTypes('GET_ALL_BOOKING_ADMIN');
export const deleteBookingType = createActionTypes('DEL_BOOKING');
