...
import { getAllEmployeeType, getAllTourType, getAllUserType } from '../../redux/actionTypes';


const PageDashBoard = () => {
    const dispatch = useDispatch();

    const { tourState: { tours = [], isRefresh },
        userState: { listUsers = [] },
        employeeState: { listEmployee = [] }
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="card card-statistic-1">
                                    ...
                                    <div className="card-wrap">
                                        ...
                                        <div className="card-body">{tours.length || 0}</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="card card-statistic-1">
                                    ...
                                    <div className="card-wrap">
                                        ...
                                        <div className="card-body">{listEmployee.length || 0}</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
