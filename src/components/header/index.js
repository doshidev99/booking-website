                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a
                                                        className="navLink"
                                                        target="_blank"
                                                        href="https://blog.traveloka.com/vn/"
                                                        rel="noreferrer"
                                                    >
                                                        BLOG
                                                    </a>
                                                ...
                                                <li>
                                                    <a
                                                        className="navLink"
                                                        target="_blank"
                                                        href="https://www.weather-forecast.com/locations/Da-Nang/forecasts/latest"
                                                        rel="noreferrer"
                                                    >
                                                        WEATHER
                                                    </a>
                                                ...
                                                >
                                                    ...
                                                    {state.statusDropdown && (
                                                        <div
                                                            className="dropdown-menu dropdown-menu-right d-block mt-5"
                                                            style={{
                                                                position:
                                                                    'absolute',
                                                                top: 0,
